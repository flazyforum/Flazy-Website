  ...
  <nav class="flazy-color" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        <li><a href="/">Home</a></li>
        <li class="active"><a href="/downloads" class="active">Downloads</a></li>
    ...
    <div class="section">
      ...
      <div class="row">
        ...
        <div class="col s12 m2 ">
          <div class="card white">
            <div class="card-content">
              <span class="card-title">Advertisments</span>
                <p>
					<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
					<!-- Flazy.org -->
					<ins class="adsbygoogle"
						 style="display:block"
						 data-ad-client="ca-pub-1909099540823981"
						 data-ad-slot="3647691154"
        ...
        <div class="col s12 m5">
          <div class="card white">
            <div class="card-content">
              <span class="card-title">Flazy 0.7.1</span>
        ...
        <div class="col s12 m5 ">
          <div class="card white">
            <div class="card-content">
              <span class="card-title">Flazy 0.7.2 Apha</span>
